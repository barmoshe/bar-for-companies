...
export const SITES: Site[] = [
  ...
  },
  {
    id: 'monday-payments',
    company: 'monday.com',
    role: 'Software Engineer, Payments Foundations Group',
    roleType: 'fullstack',
    url: 'https://bar-for-monday.vercel.app',
    domain: 'monday.com',
    accent: '#6161FF',
    tagline: 'Their pricing brand, recast as a working billing engine.',
    appliedOn: '2026-07-15',
  },
  {
    id: 'monday',
    ...
    roleType: 'ai',
    url: 'https://bar-for-monday.vercel.app/revai',
    domain: 'monday.com',
    accent: '#6161FF',
    tagline: 'Their agents-era homepage brand: you lead, I build agents.',
    appliedOn: '2026-07-03',
  },
  {
    id: 'qbiq',
  ...
  },
  {
    id: 'descope-mcp',
    company: 'Descope',
    role: 'Senior Software Engineer, MCP',
    roleType: 'ai',
    url: 'https://bar-for-descope.vercel.app',
    domain: 'descope.com',
    accent: '#7DEDED',
    tagline: 'Their identity-journey flow, recast as an MCP auth handshake: an agent call passing through the Descope key into the tool.',
    appliedOn: '2026-07-17',
  },
  {
    id: 'descope',
    ...
    role: 'Full Stack Software Engineer',
    roleType: 'fullstack',
    url: 'https://bar-for-descope.vercel.app/fullstack',
    domain: 'descope.com',
    accent: '#7DEDED',
